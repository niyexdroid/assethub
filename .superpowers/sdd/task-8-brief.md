...
Create `web/src/pages/shared/Notifications.tsx` — paginated notification list with read/unread styling, mark-read and mark-all-read.
...
2. Commit: `git add web/src/pages/shared/Notifications.tsx && git commit -m "feat: add shared Notifications page"`

## Global Constraints

- Catch blocks: silent for notification actions (mark read failures shouldn't block the user)
