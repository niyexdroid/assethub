...
import { LayoutDashboard, Building2, Users, CreditCard, MessageSquare, Settings, X } from 'lucide-react'
...
const LANDLORD_NAV = [
  ...
  { to: '/landlord/tenancies', icon: Users, label: 'Tenants' },
  { to: '/landlord/payments', icon: CreditCard, label: 'Payments' },
  { to: '/landlord/complaints', icon: MessageSquare, label: 'Complaints' },
